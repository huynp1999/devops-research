...
Kubernetes là một hệ thống phức tạp bao gồm nhiều thành phần và ràng buộc phức tạp đằng sau. Để backup và restore thành công, công cụ backup sẽ cần cover các tiêu chí sau:
...
- **Dữ liệu nhất quán**: Đảm bảo dữ liệu nhất quán trong và sau khi backup
...
### 4.1 Khả năng Disaster Recovery
...
### 4.4 Xét về tính chất open-source
